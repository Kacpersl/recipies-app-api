...
def image_upload_url(recipe_id):
    """create and return am image upload url"""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_get_recipes(self):
        """test retrieving recipes list fro authenticated user"""
    ...
    def test_create_recipe_with_new_ingredients(self):
        ...
        payload = {
            ...
            'time_minutes': 50,
            'price': Decimal('4.30'),
            'ingredients': [{'name': 'Loaf'}, {'name': 'soft'}],
        }
    ...
    def test_clear_recipe_ingredients(self):
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='gar')
        recipe = create_recipe(user=self.user)
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title='American Food')
        tag1 = Tag.objects.create(user=self.user, name='Vegan')
        tag2 = Tag.objects.create(user=self.user, name='Vegetarian')
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe(user=self.user, title='Polish Food')
